            ...
            try {
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    ...
                    public void run() {
                        ...
                        ccCpy.writeAndFlush(data.rduplicate(), promise);
                    }
                });
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    ...
                    public void run() {
                        ...
                        promise.addListener(new ChannelFutureListener() {
                            @Override
                            public void operationComplete(ChannelFuture future) throws Exception {
                                ccCpy.writeAndFlush(data2.rduplicate(), ccCpy.newPromise());
                            }
                        });
                        ccCpy.writeAndFlush(data.rduplicate(), promise);
                    }
                ...
                public void run() {
                    ...
                    promise.addListener(new ChannelFutureListener() {
                        ...
                        public void operationComplete(ChannelFuture future) throws Exception {
                            ...
                            serverChannelCpy.writeAndFlush(data2.rduplicate(), serverChannelCpy.newPromise());
                        }
                    });
                    ccCpy.writeAndFlush(data.rduplicate(), promise);
                }
                        ...
                        promise.addListener(new ChannelFutureListener() {
                            ...
                            public void operationComplete(ChannelFuture future) throws Exception {
                                ...
                                serverChannelCpy.writeAndFlush(
                                        data2.rduplicate(), serverChannelCpy.newPromise());
                            }
                        });
                        ccCpy.writeAndFlush(data.rduplicate(), promise);
                    }
        ...
        try {
            ...
            try {
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    @Override
                    public void run() {
                        ccCpy.writeAndFlush(data.rduplicate(), ccCpy.newPromise())
                            ...
                            public void operationComplete(ChannelFuture future) throws Exception {
                                serverChannelCpy.eventLoop().execute(new OneTimeTask() {
                                    ...
                                    public void run() {
                                        ...
                                        serverChannelCpy.writeAndFlush(data2.rduplicate(),
