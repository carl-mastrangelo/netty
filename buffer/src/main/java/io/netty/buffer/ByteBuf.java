 ...
 *   <li>{@link #rduplicate()}</li>
 *   <li>{@link #rslice()}</li>
 *   <li>{@link #rslice(int, int)}</li>
 *   <li>{@link #readRSlice(int)}</li>
 * </ul>
 ...
 * need to create a derived buffer with increased reference count, consider using {@link #rduplicate()},
 * {@link #rslice()}, {@link #rslice(int, int)} and {@link #readRSlice(int)} which may return
...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
     ...
     *         if {@code length} is greater than {@code this.readableBytes}
     */
    public abstract ByteBuf readRSlice(int length);
