...
public final class ByteBufUtil {
     ...
     */
    public static ByteBuf rduplicate(ByteBuf buf) {
     ...
     */
    public static ByteBuf rslice(ByteBuf buf) {
        final int index = buf.readerIndex();
        return rslice(buf, index, buf.writerIndex() - index);
    }

    /**
     * Creates a retained slice of the specified {@link ByteBuf}.
     */
    public static ByteBuf rslice(ByteBuf buf, int index, int length) {
